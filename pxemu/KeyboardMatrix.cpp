...
int KeyboardMatrix::translate(WPARAM virtkey, LPARAM keydata)
{
	...
	case 'Q': result = MATRIX(3,3); break;
	case 'W': result = MATRIX(3,2); break;
	case 'E': result = MATRIX(3,1); break;
	case 'R': result = MATRIX(3,0); break;
	case 'T': result = MATRIX(4,7); break;
	case 'Y': result = MATRIX(4,6); break;
	case 'U': result = MATRIX(4,5); break;
	case 'I': result = MATRIX(4,4); break;
	case 'O': result = MATRIX(4,3); break;
	case 'P': result = MATRIX(4,2); break;
	case 'A': result = MATRIX(4,1); break;
	case 'S': result = MATRIX(4,0); break;
	case 'D': result = MATRIX(5,7); break;
	case 'F': result = MATRIX(5,6); break;
	case 'G': result = MATRIX(5,5); break;
	case 'H': result = MATRIX(5,4); break;
	case 'J': result = MATRIX(5,3); break;
	case 'K': result = MATRIX(5,2); break;
	case 'L': result = MATRIX(5,1); break;
	case 'Z': result = MATRIX(5,0); break;
	case 'X': result = MATRIX(6,7); break;
	case 'C': result = MATRIX(6,6); break;
	case 'V': result = MATRIX(6,5); break;
	case 'B': result = MATRIX(6,4); break;
	case 'N': result = MATRIX(6,3); break;
	case 'M': result = MATRIX(6,2); break;	
	};
