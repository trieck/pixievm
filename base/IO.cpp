...
IOPtr IO::instance(IO::getInstance());
...
void IO::reset()
{
	...
	TIMER_A_LO = TIMER_A_HI = TIMER_B_LO = TIMER_B_HI = 0xFF;
}

/////////////////////////////////////////////////////////////////////////////
uint8_t IO::readRegister(uint16_t address)
{
	return regs[address & 0x0F];
}

/////////////////////////////////////////////////////////////////////////////
void IO::writeRegister(uint16_t address, uint8_t b)
{
	regs[address & 0x0F] = b;
}

/////////////////////////////////////////////////////////////////////////////
void IO::keyOn(uint8_t key_code)
{
	int byte = key_code >> 3;
	int bit = key_code & 7;
...
/////////////////////////////////////////////////////////////////////////////
void IO::keyOff(uint8_t key_code)
{
	int byte = key_code >> 3;
	int bit = key_code & 7;
	key_matrix[byte] |= (1 << bit);
